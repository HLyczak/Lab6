...
namespace Lab6
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            users.Add(new User() { Name = "Róża", Role = "MODERATOR", Age = 65, Marks = null, CreatedAt = new DateTime(20020, 04, 20) });
            ...
            users.Add(new User() { Name = "Dawid", Role = "STUDENT", Age = 10, Marks = new int[] { 5, 5, 5 }, CreatedAt = new DateTime(2020, 06, 20) });
            users.Add(new User() { Name = "Marcin", Role = "STUDENT", Age = 11, Marks = new int[] { 3, 2, 3 }, CreatedAt = new DateTime(2020, 06, 20) });
            users.Add(new User() { Name = "Damian", Role = "STUDENT", Age = 16, Marks = new int[] { 5, 5, 3 }, CreatedAt = new DateTime(2020, 06, 20) });
            ...
            users.Add(new User() { Name = "Kamila", Role = "STUDENT", Age = 6, Marks = new int[] { 1, 4, 4 }, CreatedAt = new DateTime(2020, 06, 20) });
            users.Add(new User() { Name = "Dawid", Role = "STUDENT", Age = 14, Marks = new int[] { 5, 4, 3 }, CreatedAt = new DateTime(2020, 06, 20) });
            users.Add(new User() { Name = "Paulina", Role = "STUDENT", Age = 10, Marks = new int[] { 4, 4, 2 }, CreatedAt = new DateTime(2020, 06, 20) });
        }
    }
}